...
export default function BookingMedium() {
  return (
    <div class="booking-medium-container">
        ...
        <input type="checkbox" id="video-call" name="video-call" value="Video Call" class="video-checkbox" />
        <img src="video-camera.png" alt="video camera icon" class="video-camera-img"/>
        <label for="video-call">Video Call</label>
        </div>

        <div class="phone-option-container">
        <input type="checkbox" id="phone-call" name="phone-call" value="Phone" class="phone-checkbox" />
