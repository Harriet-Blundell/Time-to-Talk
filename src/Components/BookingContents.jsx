...
export default function BookingContents({handleVideoCheckboxChange, checked}) {
  return (
    <div class="book-meeting-container">
      <h1 class="booking-header">Book a meeting</h1>
      <p class="booking-text">Method:</p>
      <BookingMedium handleVideoCheckboxChange={handleVideoCheckboxChange} checked={checked}/>
    </div>
  );
}
